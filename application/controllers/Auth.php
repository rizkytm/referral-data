...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            Congratulations! your account created. Please Activate Your Account
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button></div>');
            redirect('auth');
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'rhizlock.holmes@gmail.com',
            'smtp_pass' => 'Holmes97',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
        ...
        $this->email->from('rhizlock.holmes@yahoo.com', 'Rhizlock Moriarty');
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $email = $this->input->post('email');
            $user = $this->db->get_where('user_account', ['email' => $email, 'is_active' => 1])->row_array();
